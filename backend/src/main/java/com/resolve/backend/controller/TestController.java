...
@RestController // Combines @Controller + @ResponseBody — every method returns data directly (not a view/template).
@RequestMapping("/api/test") // Base path for all endpoints in this controller.
@RequiredArgsConstructor // Lombok: generates constructor for the final field, enabling constructor injection.
